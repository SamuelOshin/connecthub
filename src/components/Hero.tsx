...
export function Hero() {
  return (
    <div className="w-full min-h-screen flex items-center pt-24 pb-12 relative overflow-hidden bg-background-light dark:bg-background-dark">
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-center justify-between">
          <div className="flex flex-col gap-6 flex-1 w-full lg:max-w-[45%] z-10">
            <div className="flex flex-col gap-4 text-center lg:text-left">
              <h1 className="text-slate-900 dark:text-white font-serif leading-[1.05] tracking-tight">
                <span className="block text-4xl sm:text-5xl lg:text-6xl font-medium italic mb-1">Real People.</span>
                <span className="block text-5xl sm:text-6xl lg:text-7xl font-black text-primary">
                  Real Connections<span className="text-[#FFB020]">.</span>
                </span>
              </h1>
              <p className="text-slate-600 dark:text-gray-300 text-lg font-medium leading-relaxed font-body max-w-md mx-auto lg:mx-0">
